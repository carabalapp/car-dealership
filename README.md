...
$ curl --location 'http://localhost:3000/cars/25e97f7a-451f-4ba2-8d09-97b3da906e54'

# Actualizar un carro
$ curl --location --request PATCH 'localhost:3000/cars/7012b04a-05a2-4dd2-a957-b29bacf3073d' \
--data '{
    "brand": "Prueba1",
    "model": "Prueba2"
  }'
...
# Eliminar un carro
$ curl --location --request DELETE 'localhost:3000/cars/986805e8-1ea7-4e75-a626-a3e2daa8eb68'
